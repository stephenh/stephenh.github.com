...
1. N+1 AJAX calls? 1 for the parent, plus N for each child?
   ...
   * Pro: This fits naturally with generated endpoints, but sucks performance wise
...
* No, just take all properties every time
  * Pro: It's easier.
...
* Yes, accept child updates
  * asdf
* No, do not accept child updates
