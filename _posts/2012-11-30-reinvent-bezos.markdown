...
* Don't ask "what's going to change in 10 years"...ask "what's is *not* going to change in the next 10 years"?
* That's what you can build a business around: stability.
* For retail this is stuff like low prices, huge catalog.
...
* Select people who want to explore, want to invent (vs. people whose view point is destroying the competition--that can be successful too, but is different)
...
* The Internet empowers users with better information each year (e.g. price comparison--used to require driving store to store, then phone calls, now just Google)
...
* Per line-workers "stopping the line":
  ...
  * amazon.com customer service rep knew a customer was going to want to return a table ("everyone returns this table")--but no communication was happening with distrubtion. The communication doesn't happen automatically. Now customer service reps can pull products from website until customer complaints are addressed.
* Kaizen training: fiery "insultant". Don't sweep, eliminate the source of the dirt.
* Retail margins are thin. High margins cover a lot of sins, so you don't need to be efficient. And it's more fun to align with customers anyway.
...
* Allows solving things that you couldn't otherwise. Time horizons matter.
...
Blue Origin: you can't practice with non-reusable vehicles, will never be low cost.
